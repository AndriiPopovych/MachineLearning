            ...
            */
            ...
            return $file.get(path)
                .then(function(array) {  // calculate fares
                    ...
                    //console.log(data);
                    var myFares = [];
                    /*if (type == "2") { // ïåðåâ³ðÿºìî îáìåæåííÿ ïî âèáîðó ðèçèê³â
                    ...
                    // ÿêùî ñòðàõîâà îñîáà íå äîð³âíþº ççàñòðàõîâàíîìó,
                    // òî çì³íþºòüñÿ òàðèô ïî wop (â ïðîãðàì³ ÒÀÑ Ìàêñèìóì)
